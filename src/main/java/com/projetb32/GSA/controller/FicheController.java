...
public class FicheController {
	...
	@GetMapping("/fichecalanderid/{calanderid}")
	public ResponseEntity<List<Fiche>>  Getcalandarbydateanduser(@PathVariable Long calanderid ) 
	{
        List<Fiche> locausList;
        locausList = ficheRepository.findfichclanader(calanderid);		
